...
namespace DocuSignAPIWalkthrough04
{
    public class RequestSignatureOnDocument
    {
        public static void Main()
        {
            ...
            string recipientEmail = "ronnie.davies@safeauto.com";			// recipient (signer) email
            string documentName = "GA_Excluded_Driver_Form.pdf";			// copy document with same name and extension into project directory (i.e. "test.pdf")
